...
class ServicioControllerTest {
    ...
    private ServicioResponseDTO crearResponseDePrueba() {
        return new ServicioResponseDTO(1L, 10L, "Spa", "Masajes relajantes", 15000.0, "wellness", true, true);
    }
    ...
    // ---------- GET /api/servicios/hotel/{hotelId} ----------

    @Test
    void obtenerPorHotel_deberiaRetornar200YServiciosDelHotel() throws Exception {
        when(servicioService.obtenerPorHotel(10L)).thenReturn(List.of(crearResponseDePrueba()));

        mockMvc.perform(get("/api/servicios/hotel/10"))
                .andExpect(status().isOk())
    ...
    void crear_deberiaRetornar201_cuandoDatosValidos() throws Exception {
        ServicioRequestDTO request = new ServicioRequestDTO(10L, "Spa", "Masajes relajantes", 15000.0, "wellness", true);
    ...
    void crear_deberiaRetornar400_cuandoNombreVacio() throws Exception {
        ServicioRequestDTO request = new ServicioRequestDTO(10L, "", "Masajes relajantes", 15000.0, "wellness", true);
    ...
    void crear_deberiaRetornar400_cuandoPrecioMenorAlMinimo() throws Exception {
        ServicioRequestDTO request = new ServicioRequestDTO(10L, "Spa", "Masajes relajantes", 500.0, "wellness", true);
    ...
    void crear_deberiaRetornar400_cuandoHotelIdNoExiste() throws Exception {
        ServicioRequestDTO request = new ServicioRequestDTO(999L, "Spa", "Masajes relajantes", 15000.0, "wellness", true);
        when(servicioService.crear(any(ServicioRequestDTO.class)))
                .thenThrow(new com.hotel.msservicios.exception.HotelInvalidoException("No existe un hotel con id: 999"));
    ...
    void actualizar_deberiaRetornar200_cuandoDatosValidos() throws Exception {
        ServicioRequestDTO request = new ServicioRequestDTO(10L, "Spa Premium", "Nueva desc", 20000.0, "wellness", false);
        ServicioResponseDTO response = new ServicioResponseDTO(1L, 10L, "Spa Premium", "Nueva desc", 20000.0, "wellness", false, true);
    ...
    void actualizar_deberiaRetornar404_cuandoNoExiste() throws Exception {
        ServicioRequestDTO request = new ServicioRequestDTO(10L, "Spa", "desc", 15000.0, "wellness", true);
